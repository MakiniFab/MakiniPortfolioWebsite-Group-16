  ...
  const projects = [
    {
      ...
      imageUrl: 'https://via.placeholder.com/300?text=E-Commerce+Website', 
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/300?text=Notebook+App', 
      projectLink: 'https://example.com/notebook',
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/300?text=Gaming+Site',
